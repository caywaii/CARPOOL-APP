...
$sql = "SELECT * FROM users WHERE uUserType != 'Admin'";
$result = $conn->query($sql);

$sqlSum = "SELECT SUM(uBalance) AS 'TotalAmount' FROM users";
...
<body>
    <div class="container">
    <hr>
    <h3 align="center">Balance Tickets</h3>
    ...
    <table class="table-responsive" style="width:100%">
        ...
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center">Balance Ticket</th>
