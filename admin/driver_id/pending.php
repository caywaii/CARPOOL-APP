...
WHERE pTypeID = 'driver' AND verify_driver = 0;";
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center"> <?= $row['pNumberID'] ?> </td>
                            <td class="text-center">
                                <a href="id_approve.php?pass_id=<?= $row['pID'] ?>" class="btn btn-primary"> Approve </a>
                                <a href="id_reject.php?pass_id=<?= $row['pID'] ?>" class="btn btn-danger"> Reject </a>
                            </td>
                        </tr>
                <?php
                        $x++;
